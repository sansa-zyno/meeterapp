...
import 'package:meeter/Providers/firebase_api.dart';
...
import 'package:meeter/Providers/stream_bloc.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (_) => StreamBloc(), lazy: false),
        StreamProvider(
            create: (_) => FirebaseApi().getMeeterUids(), lazy: false),
        StreamProvider(
            create: (_) => FirebaseApi().getDemandUids(), lazy: false)
      ],
      child: MaterialApp(
